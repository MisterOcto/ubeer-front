...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    ubeerAuthUserSubject.add(
      UbeerAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<UbeerAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  UbeerAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = UbeerAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    ubeerAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
